...
import { Boxes, FolderTree, LayoutDashboard, LogOut, Menu, Settings, ShoppingBag, Truck, X } from "lucide-react";
import { useState } from "react";
import { logoutAction } from "@/app/admin/actions";

const links = [
  ["Dashboard", "/admin", LayoutDashboard],
  ["Productos", "/admin/productos", Boxes],
  ["Categorías", "/admin/categorias", FolderTree],
  ["Envíos", "/admin/envios", Truck],
